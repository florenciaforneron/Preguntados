...
class PDF extends fpdf
{
    ...
    function Header()
    {
        $this->Image('third-party/fpdf/logoPrincipal.png', 110, 5, 80); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
        ...
        $this->Cell(30,10, utf8_decode('Opción A'), 1, 0, 'C', 1);
        $this->Cell(30, 10, utf8_decode('Opción B'), 1, 0, 'C', 1);
        $this->Cell(30, 10, utf8_decode('Opción C'), 1, 0, 'C', 1);
        $this->Cell(30, 10, utf8_decode('Opción D'), 1, 0, 'C', 1);
